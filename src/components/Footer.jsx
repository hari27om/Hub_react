    ...
    return <Box bgColor={'blackAlpha.900'} minH={'40'} p={'16'} color={'white'}>
        ...
        <Stack direction={['column', 'row']}>
            ...
            <VStack w={'full'}>
                ...
                <Button variant={"link"} colorScheme={"whiteAlpha"} ><a  target='blank' href="https://www.linkedin.com/in/hari27om/">Linkedin</a></Button>
                <Button variant={"link"} colorScheme={"whiteAlpha"} ><a target='blank' href="https://github.com/hari27om">Github</a></Button>
            </VStack>
